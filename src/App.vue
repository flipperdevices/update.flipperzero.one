...
export default {
  ...
  mounted() {
    ...
    else if (navigator.userAgent.indexOf("OPR") !== -1) this.userAgent.browser = 'Opera'
    else if (navigator.userAgent.indexOf("Edg") !== -1) this.userAgent.browser = 'Edge'
    else if (navigator.userAgent.indexOf("Chrome") !== -1) this.userAgent.browser = 'Chrome'
